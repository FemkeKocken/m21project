...
### looks like this bitch predicted that exactly this would happen and planned a catch up week. Well played, Femke from the past, well played. ###

Goals for this week: 
 - finish up the usertests 
 - figure out how to organize the data and how to present it 
 - write down the preliminary results 
 - finsh up the draft methodology 
 - start draft on results 

okay 5 things to do, 5 days in the week. Should be within my power. He ho let's go. 
...
THis morning I have done a List of Requirements as well as the recording of the scenarios. Which, though I was making a big deal out of in my head, went down pretty smooth. Very happy with that, the scenarios set the tone quite well. 

I think I should definitly focus on the shape of these concepts. Are they going to be games, physical prototype, installations? I think I would score extra points if I can make it experiencable for the Netherlands. So perhaps some online kind of prototype? 

I should also look into my planning some time today.. Is it still making sense? 

![image](https://user-images.githubusercontent.com/50365794/227991383-e2ce02bd-e19c-4c55-8615-999e62b0b06c.png)
Updated the Miro board with the soundclips and LOR 
